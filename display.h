...
void init_display(int width, int height)
{
    ...
    dst_rect.x = 0;dst_rect.y = 0;dst_rect.width = width;dst_rect.height = height;
    src_rect.x = 0;src_rect.y = 0;src_rect.width = width << 16;src_rect.height = height << 16;
    dispmanx_display = vc_dispmanx_display_open(0);
    dispmanx_update = vc_dispmanx_update_start(0);
    dispmanx_element =
    vc_dispmanx_element_add(dispmanx_update, dispmanx_display,
                            0, &dst_rect, 0,
